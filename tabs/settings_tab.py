...
class SettingsTab(BaseTab):
    ...
    def add_separator(self):
        """구분선 추가"""
        separator_frame = ttk.Frame(self.frame, height=1)
    ...
    def create_settings_tab(self):
        """설정 탭 UI 생성"""
        # API 설정
        api_frame = ttk.LabelFrame(self.frame, text="🔑 API 설정", style="Section.TLabelframe")
        ...
        # 상품 상태 설정
        product_status_frame = ttk.LabelFrame(self.frame, text="📦 상품 상태 설정", style="Section.TLabelframe")
        ...
        # 알림 설정
        notification_frame = ttk.LabelFrame(self.frame, text="🔔 알림 설정", style="Section.TLabelframe")
        ...
        # 주문 컬럼 설정
        order_column_frame = ttk.LabelFrame(self.frame, text="📋 주문 컬럼 설정", style="Section.TLabelframe")
        ...
        # IP 관리 설정 (컴팩트 버전)
        ip_management_frame = ttk.LabelFrame(self.frame, text="🌐 허가된 공인 IP 관리", style="Section.TLabelframe")
